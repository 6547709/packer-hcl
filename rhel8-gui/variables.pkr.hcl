...
variable "vsphere_server" {
  type        = string
  description = "The fully qualified domain name or IP address of the vCenter Server instance. (e.g. 'mgmt-vc02.corp.local')"
}
...
variable "iso_url" {
  type        = string
  description = "The path of the OS install image. (e.g. '[FC-LUN0] 0-ISO/CentOS-7-x86_64-DVD-2009.iso')"
}
...
variable "vm_video_ram" {
  type        = string
  description = "The vm video memory size. (e.g. '1024')"
}
